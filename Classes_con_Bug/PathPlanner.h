...
public:
	...
	//copy constructor
	ShortestPathStep(const ShortestPathStep& step);
...
public:
	...
	std::vector<ShortestPathStep*> Start_A_Star(cocos2d::CCPoint source, cocos2d::CCPoint dest);
...
private:
	...
	std::vector<ShortestPathStep*> mOpenSteps;
	std::vector<ShortestPathStep*> mClosedSteps;

	std::vector<ShortestPathStep*> Calculate_A_Star(cocos2d::CCPoint source, cocos2d::CCPoint dest);
	...
	std::vector<ShortestPathStep*> constructPathAndStartAnimationFromStep(ShortestPathStep* step);
};
